...
CLIMATE_CSS = """
    ...
    .preview-bar {
      ...
      color: #e0b070; font-size: 0.68rem; font-weight: 700;
      padding: 0.3rem 1rem; text-align: center; letter-spacing: 0.02em;
    }
    .preview-bar a { color: #f0b020; }
    .preview-bar .sw { margin-left: 0.5rem; }
"""
...
CLIMATE_JS = """
  ...
  (function () {
    ...
    if (spark) {
      ...
      var lb = el("text", { x: W - 2, y: sy(28) - 2.5, class: "thresh-text", "text-anchor": "end" });
      lb.textContent = "28℃";
      f.appendChild(lb);
      spark.appendChild(f);
    }
